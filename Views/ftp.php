                  ...
                  <div class="page-header-content-inner">
                    <div class="page-header-content">
                      ...
                      <div class="breadcrumb-wrapper">
                        ...
                        <span class="bread-sep">&nbsp;/&nbsp;</span>FTP Register
                      </div>
                      <div></div>
                    </div>
                  </div>
                  ...
                  <div class="layer-content">
                    ...
                    <div class="ttm-tabs ttm-tab-style-02">
                      <div class="react-tabs" data-tabs="true">
                        ...
                        <!--    <li class="tab react-tabs__tab--selected" role="tab" id="react-tabs-0" aria-selected="true" aria-disabled="false" aria-controls="react-tabs-1" tabindex="0"><a><i class="flaticon flaticon-research"></i><span>Candidate</span>-->
                        <!--            <h5>Login as a Candidate</h5>-->
                        <!--        </a></li>-->
                        <!--    <li class="tab" role="tab" id="react-tabs-2" aria-selected="false" aria-disabled="false" aria-controls="react-tabs-3"><a><i class="flaticon flaticon-job-search"></i><span>Employer</span>-->
