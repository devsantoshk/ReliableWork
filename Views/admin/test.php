<?php $conn = DbConfig(); ?>
  ...
  <link href="../Src/Inc/Views/admin/css/bootstrap5.0.1.min.css" rel="stylesheet" crossorigin="anonymous">
  <link rel="stylesheet" type="text/css" href="../Src/Inc/Views/admin/css/datatables-1.10.25.min.css" />
  <style type="text/css">
    .btnAdd {
      text-align: right;
      width: 83%;
...
<body>
  ...
  <script src="../Src/Inc/Views/admin/js/jquery-3.6.0.min.js" crossorigin="anonymous"></script>
  <script src="../Src/Inc/Views/admin/js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
  <script type="text/javascript" src="../Src/Inc/Views/admin/js/dt-1.10.25datatables.min.js"></script>
